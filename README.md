...
(si ya tenías previamente instalado yt-dlp con apt por favor remuevalo con 'sudo apt purge yt-dlp' e instalelo con snap o simplemente ejecute directamente el script de yt.sh o yt-deb.sh)
